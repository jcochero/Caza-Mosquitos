...
public anywheresoftware.b4a.objects.ButtonWrapper _btspray = null;
...
public anywheresoftware.b4a.objects.PanelWrapper _panelcaract = null;
...
mostCurrent._panelcaract.Initialize(mostCurrent.activityBA,"");
...
mostCurrent._activity.AddView((android.view.View)(mostCurrent._panelcaract.getObject()),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 183;BA.debugLine="panelCaract.LoadLayout(\"lay_dondeCria_Caract\")";
mostCurrent._panelcaract.LoadLayout("lay_dondeCria_Caract",mostCurrent.activityBA);
...
mostCurrent._panelcaract.LoadLayout("lay_dondeCria_Ejemplos",mostCurrent.activityBA);
...
mostCurrent._panelcaract.RemoveView();
...
mostCurrent._btspray = new anywheresoftware.b4a.objects.ButtonWrapper();
...
mostCurrent._panelcaract = new anywheresoftware.b4a.objects.PanelWrapper();
