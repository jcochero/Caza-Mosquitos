...
public class frminstrucciones extends Activity implements B4AActivity{
	public static frminstrucciones mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "caza.mosquito", "caza.mosquito.frminstrucciones");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (frminstrucciones).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "caza.mosquito", "caza.mosquito.frminstrucciones");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "caza.mosquito.frminstrucciones", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (frminstrucciones) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (frminstrucciones) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (frminstrucciones) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (frminstrucciones) Pause event (activity is not paused). **");
        if (mostCurrent != null)
    ...
    private static class ResumeMessage implements Runnable {
		...
		public void run() {
            frminstrucciones mc = mostCurrent;
...
mostCurrent._activity.LoadLayout("layInst_EncontreMosquito",mostCurrent.activityBA);
 ...
 //BA.debugLineNum = 23;BA.debugLine="Activity.LoadLayout(\"layInst_EncontreCriadero\")";
...
public static String  _but_cerrar_click() throws Exception{
 //BA.debugLineNum = 37;BA.debugLine="Sub but_Cerrar_Click";
...
public static String  _butseguir_click() throws Exception{
 //BA.debugLineNum = 42;BA.debugLine="Sub butSeguir_Click";
