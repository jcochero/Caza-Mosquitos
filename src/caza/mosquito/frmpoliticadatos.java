...
public class frmpoliticadatos extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "caza.mosquito", "caza.mosquito.frmpoliticadatos");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "caza.mosquito", "caza.mosquito.frmpoliticadatos");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "caza.mosquito.frmpoliticadatos", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._activity.LoadLayout("layPoliticaDatos",mostCurrent.activityBA);
 //BA.debugLineNum = 29;BA.debugLine="pnlPoliticaDatos.RemoveView";
mostCurrent._pnlpoliticadatos.RemoveView();
 //BA.debugLineNum = 30;BA.debugLine="scrPoliticaDatos.Panel.AddView(pnlPoliticaDatos,0";
...
public static String  _btncerrarpoliticadatos_click() throws Exception{
 //BA.debugLineNum = 44;BA.debugLine="Sub btnCerrarPoliticaDatos_Click";
 //BA.debugLineNum = 45;BA.debugLine="Activity.RemoveAllViews";
