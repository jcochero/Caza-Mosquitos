...
{
final int step47 = 1;
final int limit47 = (int) (mostCurrent._markerslist.getSize()-1);
_i = (int) (0) ;
...
if ((_snippet).equals(mostCurrent._main._username /*String*/ ) && (_listmostrarconfig.Get((int) (0))).equals((Object)("usuario"))) { 
...
mostCurrent._markersoverlay.AddItem((uk.co.martinpearman.osmdroid.views.overlay.Marker)(_markeramostrar.getObject()));
 }else if((_snippet).equals(mostCurrent._main._username /*String*/ ) == false && (_listmostrarconfig.Get((int) (1))).equals((Object)("otrosusuarios"))) { 
...
{
final int step34 = 1;
final int limit34 = (int) (mostCurrent._main._speciesmap /*anywheresoftware.b4a.objects.collections.List*/ .getSize()-1);
_i = (int) (0) ;
...
anywheresoftware.b4a.keywords.Common.LogImpl("436241433","init fusedlocationproviderExplorar",0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("436241437","connecting fusedlocationproviderExplorar",0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("436372481","FusedLocationProvider1_ConnectionFailed",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("436438017","FusedLocationProvider1_ConnectionSuccess",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("436503553","FusedLocationProvider1_ConnectionSuspended",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("436569089","FusedLocationProvider1_LocationChanged",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("436569091",BA.NumberToString(_lastlocation.getLatitude()),0);
 //BA.debugLineNum = 244;BA.debugLine="Log(LastLocation.Longitude)";
anywheresoftware.b4a.keywords.Common.LogImpl("436569092",BA.NumberToString(_lastlocation.getLongitude()),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("436634625","FusedLocationProvider1_LocationSettingsChecked",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("436634629","RESOLUTION_REQUIRED",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("436634634","SETTINGS_CHANGE_UNAVAILABLE",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("436634644","SUCCESS",0);
 break; }
}
;
...
anywheresoftware.b4a.keywords.Common.LogImpl("436896769","GetMapa messages: "+BA.ObjectToString(_job._success /*boolean*/ ),0);
...
mostCurrent._markerinfo.setTextSize((float) (8));
...
anywheresoftware.b4a.keywords.Common.LogImpl("436896890","GetMapa not ok",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("436700161","LocationSettingsResult1_ResolutionDialogDismissed",0);
...
mostCurrent._markerinfo.setText(BA.ObjectToCharSequence("Criadero "+anywheresoftware.b4a.keywords.Common.CRLF+"Contribución: "+_snippet));
 }else {
...
mostCurrent._markerinfo.setText(BA.ObjectToCharSequence("Aedes "+_marker1.GetTitle()+anywheresoftware.b4a.keywords.Common.CRLF+"Contribución: "+_snippet));
 };
